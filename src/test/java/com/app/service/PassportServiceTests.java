...
class PassportServiceTests {
	...
	void TestApplicationNoTrue() {
		...
		try {
			...
			doc.add(documents);
			PassportApplication passportApplication = new PassportApplication(220, "John", "as", "Will", "Male", bDate,
					"Bombay", "unmarried", true, "student", "Graduate", address, doc, false, cDate3, uDate4, user);
